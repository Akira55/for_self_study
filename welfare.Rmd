...
Conduct welfare analysis using the setting below. In other words, culculate the equilibrium price and the area　between the price and demand curb.
...
Firstly, we need to get the equilibrium price. To solve this foumula, it is common to define functions.
...
The last funtion `solver` is for solving the equilibrium. Culucluating the price means solve
